...
filledAt: 2026-05-07
priority: P1
algorithmRole: "病药法 — 张神峰核心原创：用神 = 病药关系（与《子平真诠》"用神成败救应"互补）— Phase 2 救应判定 P1 印证"
---

# 神峰通考 · 病药 / 雕枯旺弱 / 损益生长：病药四病四药说类
...
- 本文件包含 1 个启发式识别的章节标题，源 epub 段落范围 [48, 94]。
