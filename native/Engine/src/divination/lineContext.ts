...
export const LINE_CONTEXT_SOURCE: RuleSource = {
  id:'liuyao-calendar-relations-v1',version:'1',title:'增删卜易：日辰、六合、六冲、旬空',
  editionStatus:'electronic-transcription-not-print-collated',
  scope:'本爻、动爻所化之爻、纯宫伏神分别计算；生克以日月为施动对象',
  references:[
  ...
  limitations:['月建五行标签不是综合旺衰；临日与月破、合与克可同时保留','空、冲、合不自动认定失效、暗动、合化或现实吉凶'],
};
