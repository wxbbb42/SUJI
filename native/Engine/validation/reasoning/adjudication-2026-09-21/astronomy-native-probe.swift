...
@main struct Probe {
 static func main() async throws {
  ...
  for (label, b) in [("bazi-regular",birth),("bazi-earth",BirthProfile(year:1980,month:1,day:26,hour:7,minute:30,gender:"男",city:"北京",longitude:120,timeZoneID:"Asia/Shanghai")),("bazi-rooted",BirthProfile(year:1993,month:6,day:8,hour:13,minute:30,gender:"男",city:"北京",longitude:120,timeZoneID:"Asia/Shanghai"))] {
  ...
  fixtures.append(Fixture(date:"2026-09-20T04:00:00Z",label:"astronomy-and-bazi",rows:[fixtures[0].rows[0],fixtures[7].rows[0]],birth:birth))
