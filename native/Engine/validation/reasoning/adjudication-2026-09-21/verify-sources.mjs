...
for(const folder of ['research-divination/efficacy-2026-09-21','research-divination/timing-2026-09-21','research-qizheng/completion-2026-09-21'])scan(path.join(root,'native/Engine/validation',folder));
const refs=[],failures=[];
for(const [file,key] of [['bazi/zhuanWangSources.ts','ZHUAN_WANG_SOURCES'],['bazi/rescueSources.ts','RESCUE_SOURCES'],['bazi/SiLing.ts','SI_LING_SOURCE'],['divination/efficacy.ts','EFFICACY_SOURCE'],['qimen/timing.ts','QIMEN_TIMING_SOURCE']]){
