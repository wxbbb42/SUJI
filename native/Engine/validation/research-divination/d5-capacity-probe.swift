...
@main struct Review {
 static func main() async throws {
  let input=try Data(contentsOf:URL(fileURLWithPath:"/tmp/suji-d5-capacity-fixtures.json"));let fixtures=try JSONDecoder().decode([Fixture].self,from:input);var reports:[[String:Any]]=[]
